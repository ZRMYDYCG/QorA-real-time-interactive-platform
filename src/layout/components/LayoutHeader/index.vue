...
watch(
  ...
  (newRoute) => {
    if (
      newRoute.path === '/findOut/latest' ||
      newRoute.path === '/findOut/commend' ||
      newRoute.path === '/findOut/unresolved' ||
      newRoute.path === '/findOut/urgent'
    ) {
      if (document.getElementById('theme-style').className === 'dark') {
        backGroundType.value = '#000'
      } else {
